...
# Taken from https://github.com/kennetham/nus-matriculation-number-validator/blob/master/nus_matric.rb

  def check_matric_number(matric)
      matric.upcase!
      calculate_nus_matric_number(matric[0..-2]) == matric
  end
